...
url(r'^library/(?P<sub>(books){0,1}?)$', 'library.views.booklist'),
url(r'^library/books/(?P<sub>\d+?)/$', 'library.views.bookinfo'),
url(r'^library/authors/?$', 'library.views.authors'),
url(r'^library/authors/(?P<sub>\d+?)/$', 'library.views.authorinfo'),
